# Generated by Django 3.1.6 on 2021-02-23 04:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('FURN', 'Furniture'), ('COLLLECT', 'Collectibles'), ('GEN', 'General')], default='GEN.', max_length=8)),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category_listings', to='auctions.category')),
